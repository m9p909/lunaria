...
const GoalPage = () => {
    ...
    return (
        <div className="flex justify-center h-screen bg-[#FEFBFF] goal">
            <div className="text-center">
                ...
                <form className="flex flex-col text-center">
                    ...
                    >
                        <ToggleGroup.Item className="flex-grow p-10 rounded-l-lg mt-10 mb-10 bg-[#b18af8] text-white" value="3 months">3 months</ToggleGroup.Item>
                        <ToggleGroup.Item className="flex-grow p-10 mt-10 mb-10 bg-[#b18af8] text-white" value="6 months">6 months</ToggleGroup.Item>
                        <ToggleGroup.Item className="flex-grow p-10 rounded-r-lg mt-10 mb-10 bg-[#b18af8] text-white" value="12 months">12 months</ToggleGroup.Item>
                    </ToggleGroup.Root>
