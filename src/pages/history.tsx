        ...
        <div className="flex flex-col justify-center text-left">
            <h1 className="font-semibold uppercase mb-2 mt-8 pb-16 text-2xl text-center">savings history</h1>
                ...
                <div className="flex flex-row text-center">
                    ...
                    <div className="bg-[#E5FFF8] hover:bg-[#B18AF8] hover:text-white text-[#372D40] border-black border-2 justify-center pt-6 pb-6 m-6 w-1/3">
                        <img className="w-1/3 h-auto object-center" src="/assets/IMG_0883.GIF"></img>
                    </div>
                </div>
                ...
                <div className="flex flex-row text-center">
                    ...
                    <div className="bg-[#E5FFF8] hover:bg-[#B18AF8] hover:text-white text-[#372D40] border-black border-2 justify-center pt-6 pb-6 m-6 w-1/3">
                    <img className="w-1/3 h-auto grayscale object-center" src="/assets/IMG_0883.GIF"></img>
                    </div>
                </div>                
